...
public class RotateByAndDriveCommand extends SequentialCommandGroup {
	 ...
	 */
	public RotateByAndDriveCommand(SwerveDrivetrain drivetrain, Rotation2d angle, double distance) {
		addCommands(
				new RotateByCommand(drivetrain, angle),
				new DriveDistanceCommand(drivetrain, new Translation2d(distance, 0), false));
	}
}
